...
@EnableJpaRepositories(entityManagerFactoryRef = "mainEntityManagerFactory",
        transactionManagerRef = "mainTransactionManager", basePackages = {"vn.com.viettel.vds.repository.main"})
public class DefaultDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean mainEntityManagerFactory(
        ...
        return builder.dataSource(dataSource).packages("vn.com.viettel.vds.model").persistenceUnit("main")
                .build();
    }
    @Primary
